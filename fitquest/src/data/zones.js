export const zones =[
    {id:'foret',name:'Forêt de Débutant',element:'wind',levelMin:1,levelMax:15,requiredLevel:1,requiredRegionalBoss:null,regionalBossId:'wolf_king',enterStepCost:0,themeColor:'#22c55e',accent:'#86efac',desc:'Une forêt sombre et silencieuse. Les sentiers serpentent entre des arbres millénaires.',svgKey:'forest'},
    {id:'marais',name:'Marais des Ombres',element:'dark',levelMin:16,levelMax:30,requiredLevel:12,requiredRegionalBoss:'wolf_king',regionalBossId:'corrupted_dryad',enterStepCost:2200,themeColor:'#a855f7',accent:'#c084fc',desc:'Brume violette et eaux stagnantes. Les ombres grouillent dans les roseaux.',svgKey:'swamp'},
    {id:'caverne',name:'Caverne de Cristal',element:'water',levelMin:31,levelMax:50,requiredLevel:28,requiredRegionalBoss:'corrupted_dryad',regionalBossId:null,enterStepCost:3800,themeColor:'#22d3ee',accent:'#67e8f9',desc:'Profondeurs scintillantes. Les cristaux résonnent d\'une magie ancienne.',svgKey:'crystal'}
];
